...
QVariant OutlineMdl1::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::DecorationRole:
        ...
        case SynTree::R_module:
            return QPixmap(":/lolacreator/images/block.png");
            /*
        case SynTree::R_module_or_udp_instance:
            return QPixmap(":/lolacreator/images/var.png");
        case SynTree::R_task_declaration:
        case SynTree::R_function_declaration:
            return QPixmap(":/lolacreator/images/func.png");
        case Tok_Section:
            return QPixmap(":/lolacreator/images/category.png");
            */
        }
        return QVariant();
    }
...
void OutlineMdl1::fillTop()
{
    ...
    foreach( const CrossRefModel::IdentDeclRef& sym, globals )
    {
        ...
        if( b->tok().d_type == SynTree::R_module )
        {
            Slot s;
            s.d_sym = b;
...
void OutlineMdl2::fill(Slot* super, const CrossRefModel::Symbol* sym )
{
