...
const char* Project::ID = "LolaCreator.Project";

Project::Project(ProjectManager* projectManager, const QString& fileName):
    d_projectManager(projectManager),d_root(0)
{
    setId(ID);
    setProjectContext(Core::Context("LolaCreator.ProjectContext"));
    setProjectLanguages(Core::Context(LolaCreator::Constants::LangLola));
...
void Project::populateDir(const QDir& dir, ProjectExplorer::FolderNode* parent )
{
    ...
    files = dir.entryList( QStringList() << QString("*.Lola")
                                           << QString("*.Mod"),
...
void Project::loadProject(const QString& fileName)
{
    ...
    d_config["SRCEXT"] << ".Lola"; // Preset
    d_config["LIBEXT"] << ".Lola";
...
QString Ll::ProjectManager::mimeType() const
{
    return QLatin1String(LolaCreator::Constants::ProjectMimeType);
}

ProjectExplorer::Project*Ll::ProjectManager::openProject(const QString& fileName, QString* errorString)
{
